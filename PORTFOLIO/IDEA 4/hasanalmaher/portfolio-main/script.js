    ...
    var t = {
            157: (t, e, r) => {
                ...
                class Mn {
                    ...
                    onClick(t) {
                        this.isSmooth && t.preventDefault();
                    ...
                    updateSizes() {
                        if (!this.isSmooth) return this.scroller.documentHeight = this.element.clientHeight, this.scroller.windowHeight = window.innerHeight, void(document.body.style.height = "");
                    ...
                    scrollTo(t, e) {
                        let r = 0,
                            i = null;
                        t instanceof window.HTMLElement ? (i = t, r = t.getBoundingClientRect().top + this.scroller.target) : "number" != typeof t && isNaN(t) ? (i = document.querySelector(t), r = i.getBoundingClientRect().top + this.scroller.target) : r = t;
                        if (!this.isSmooth) return i ? i.scrollIntoView({
                            behavior: "smooth",
                            block: "start"
                        }) : window.scrollTo({
                            top: r,
                ...
                const ss = new class {
                    ...
                    onPreloaded() {
                        document.documentElement.classList.remove("is-loading"), document.documentElement.classList.add("is-ready"), this.resize(), this.animateIntro()
                    }
                    onScroll() {
